...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('robot_driver')
    launch_dir = os.path.join(bringup_dir, 'launch')
    ekf_config = Path(get_package_share_directory('robot_driver'), 'config', 'ekf.yaml')
    imu_config = Path(get_package_share_directory('robot_driver'), 'config', 'imu.yaml')
    ...
    driver_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'driver.launch.py')),
